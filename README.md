...
seq : https://drive.google.com/file/d/1RvRjiyAlWDipZQXnuwtrvvTd1y2ti8mG/view?usp=sharing  
...
```
cd visualize
python render.py --scene_root /YOUR_REPOSITORY_PATH/parahome_dist/data/seq/s01
```
